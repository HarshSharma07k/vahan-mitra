...
export const mockWallet: WalletDocument[] = [
  {
    ...
    previewUrl: "/mock/aadhaar-clean.jpg",
    health: "VERIFIED",
    addedOn: "2026-07-02",
    fields: [
      { key: "name", label: "Name", value: "ANANYA VERMA", confidence: 0.98, box: { x: 32, y: 24, w: 44, h: 7 } },
      { key: "dob", label: "Date of birth", value: "14/02/1999", confidence: 0.97, box: { x: 32, y: 34, w: 26, h: 6 } },
      { key: "uid", label: "Aadhaar number", value: "XXXX XXXX 4471", confidence: 0.99, box: { x: 32, y: 52, w: 40, h: 8 } },
    ],
    issues: [],
  },
  {
    ...
    previewUrl: "/mock/dl-clean.jpg",
    health: "VERIFIED",
    addedOn: "2026-07-02",
    expiresOn: "2039-02-13",
    fields: [
      { key: "dlNumber", label: "Licence number", value: "HR-2620190004471", confidence: 0.96, box: { x: 30, y: 20, w: 46, h: 7 } },
      { key: "name", label: "Name", value: "ANANYA VERMA", confidence: 0.97, box: { x: 30, y: 31, w: 42, h: 7 } },
      { key: "validTill", label: "Valid till", value: "13/02/2039", confidence: 0.94, box: { x: 30, y: 60, w: 28, h: 6 } },
    ],
    issues: [],
  },
  {
    ...
    previewUrl: "/mock/insurance-expired.jpg",
    health: "EXPIRED",
    addedOn: "2026-07-04",
    expiresOn: "2026-08-12",
    fields: [
      { key: "policyNo", label: "Policy number", value: "OG-26-1102-1847-00021873", confidence: 0.93, box: { x: 12, y: 18, w: 54, h: 6 } },
      { key: "regNumber", label: "Vehicle", value: "HR26DK8337", confidence: 0.95, box: { x: 12, y: 29, w: 32, h: 6 } },
      { key: "validTill", label: "Valid till", value: "12/08/2026", confidence: 0.96, box: { x: 12, y: 40, w: 28, h: 6 } },
    ],
    issues: [
      {
        code: "EXPIRED",
  ...
  },
  {
    ...
    fields: [
      { key: "dlNumber", label: "Licence number", value: "RJ-1420030018822", confidence: 0.95, box: { x: 30, y: 20, w: 46, h: 7 } },
      { key: "name", label: "Name", value: "RAKESH KUMAR YADAV", confidence: 0.92, box: { x: 30, y: 31, w: 48, h: 7 } },
      { key: "validTill", label: "Valid till", value: "03/09/2026", confidence: 0.97, box: { x: 30, y: 60, w: 28, h: 6 } },
    ],
    issues: [],
  },
  {
    ...
    previewUrl: "/mock/rc-mismatch.jpg",
    health: "NEEDS_FIX",
    addedOn: "2026-08-01",
    fields: [
      { key: "regNumber", label: "Registration number", value: "RJ14GC4402", confidence: 0.97, box: { x: 14, y: 16, w: 34, h: 7 } },
      { key: "owner", label: "Owner name", value: "RAKESH YADAV", confidence: 0.88, box: { x: 14, y: 27, w: 40, h: 7 } },
      { key: "class", label: "Vehicle class", value: "GOODS CARRIER (LGV)", confidence: 0.91, box: { x: 14, y: 38, w: 44, h: 6 } },
    ],
    issues: [
      {
        code: "NAME_MISMATCH",
...
export const mockChallans: Challan[] = [
  {
    ...
    state: "Haryana",
    status: "PENDING",
    evidenceUrl: "/mock/evidence-speed-01.jpg",
  ...
  },
  {
    ...
    state: "Haryana",
    status: "PENDING",
    evidenceUrl: "/mock/evidence-helmet-01.jpg",
  ...
  },
  {
    ...
    state: "Delhi",
    status: "PENDING",
    evidenceUrl: "/mock/evidence-redlight-01.jpg",
  ...
  },
  {
    ...
    state: "Rajasthan",
    status: "PENDING",
    evidenceUrl: "/mock/evidence-overload-01.jpg",
...
export const mockOcrFixtures: OcrFixture[] = [
  {
    kind: "RC",
    variant: "clean",
    previewUrl: "/mock/rc-clean.jpg",
    fields: [
      { key: "regNumber", label: "Registration number", value: "HR26DK8337", confidence: 0.98, box: { x: 14, y: 16, w: 34, h: 7 } },
      { key: "owner", label: "Owner name", value: "VIKRAM SINGH RATHORE", confidence: 0.95, box: { x: 14, y: 27, w: 48, h: 7 } },
      { key: "makeModel", label: "Make and model", value: "ROYAL ENFIELD CLASSIC 350", confidence: 0.93, box: { x: 14, y: 38, w: 52, h: 6 } },
      { key: "chassis", label: "Chassis number", value: "ME3U3S5C1MK004471", confidence: 0.9, box: { x: 14, y: 49, w: 46, h: 6 } },
      { key: "engine", label: "Engine number", value: "U3S5C1MK18822", confidence: 0.89, box: { x: 14, y: 60, w: 40, h: 6 } },
      { key: "regDate", label: "Registered on", value: "18/06/2021", confidence: 0.96, box: { x: 14, y: 71, w: 28, h: 6 } },
    ],
    issues: [],
  },
  {
    kind: "RC",
    variant: "blur",
    previewUrl: "/mock/rc-blur.jpg",
    fields: [
      { key: "regNumber", label: "Registration number", value: "HR26DK8337", confidence: 0.91, box: { x: 14, y: 16, w: 34, h: 7 } },
      { key: "owner", label: "Owner name", value: "VIKRAM SINGH RATH0RE", confidence: 0.52, box: { x: 14, y: 27, w: 48, h: 7 } },
      { key: "chassis", label: "Chassis number", value: "ME3U3S5C1MK0O4471", confidence: 0.38, box: { x: 14, y: 49, w: 46, h: 6 } },
    ],
    issues: [
      {
        code: "BLUR",
  ...
  },
  {
    kind: "AADHAAR",
    variant: "mismatch",
    previewUrl: "/mock/aadhaar-mismatch.jpg",
    fields: [
      { key: "name", label: "Name", value: "ANANYA V", confidence: 0.86, box: { x: 32, y: 24, w: 34, h: 7 } },
      { key: "dob", label: "Date of birth", value: "14/02/1999", confidence: 0.97, box: { x: 32, y: 34, w: 26, h: 6 } },
      { key: "uid", label: "Aadhaar number", value: "XXXX XXXX 4471", confidence: 0.99, box: { x: 32, y: 52, w: 40, h: 8 } },
    ],
    issues: [
  ...
  },
  {
    ...
    previewUrl: "/mock/insurance-expired.jpg",
    fields: [
      { key: "policyNo", label: "Policy number", value: "OG-26-1102-1847-00021873", confidence: 0.94, box: { x: 12, y: 18, w: 54, h: 6 } },
      { key: "regNumber", label: "Vehicle", value: "HR26DK8337", confidence: 0.96, box: { x: 12, y: 29, w: 32, h: 6 } },
      { key: "validTill", label: "Valid till", value: "12/08/2026", confidence: 0.97, box: { x: 12, y: 40, w: 28, h: 6 } },
      { key: "insurer", label: "Insurer", value: "BAJAJ ALLIANZ GENERAL", confidence: 0.92, box: { x: 12, y: 51, w: 44, h: 6 } },
    ],
    issues: [
      {
        code: "EXPIRED",
  ...
  },
  {
    ...
    previewUrl: "/mock/dl-clean.jpg",
    fields: [
      { key: "dlNumber", label: "Licence number", value: "HR-2620190004471", confidence: 0.97, box: { x: 30, y: 20, w: 46, h: 7 } },
      { key: "name", label: "Name", value: "ANANYA VERMA", confidence: 0.97, box: { x: 30, y: 31, w: 42, h: 7 } },
      { key: "dob", label: "Date of birth", value: "14/02/1999", confidence: 0.95, box: { x: 30, y: 42, w: 26, h: 6 } },
      { key: "cov", label: "Vehicle classes", value: "MCWG, LMV", confidence: 0.91, box: { x: 30, y: 51, w: 30, h: 6 } },
      { key: "validTill", label: "Valid till", value: "13/02/2039", confidence: 0.96, box: { x: 30, y: 60, w: 28, h: 6 } },
    ],
    issues: [],
  },
];
